...
Route::post('/login/admin', [AuthController::class, 'loginAsAdmin'])->name('login.admin');
Route::post('/login/employee', [AuthController::class, 'loginAsEmployee'])->name('login.employee');
